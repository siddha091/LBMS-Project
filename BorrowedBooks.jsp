...
<div id="wrapper">
	...
	try
		...
		%>						
						...
						<td><a href="Checkout?rid=<%=rid%>&bid=<%=rs.getString(2)%>&bname=<%=rs.getString(3)%>&bauthor=<%=rs.getString(4)%>&bpub=<%=rs.getString(5)%>&libid=<%=rs.getString(6)%>">Checkout</a>
