...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="frm" method="post" action="AddPublisher" onsubmit="return validate(this);">
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Screen To Add Publishers<h1></div>
			<br/>
			<%
...
<table align="right">
<tr><td><b>Publisher Name</b></td><td><input type="text" name="pname" /></td></tr>
<tr><td><b>Publisher Email</b></td><td><input type="text" name="pemail"/> </td></tr>
<tr><td><b>Publisher Phone</b></td><td><input type="text" name="pmobile"/> </td></tr>
<tr><td><b>Publisher Address</b></td><td><input type="text" name="paddr"/> </td></tr>
<tr><td></td><td><input type="submit" value="Add Publisher"></td>
</td></tr></table>
</form>
			</table>
