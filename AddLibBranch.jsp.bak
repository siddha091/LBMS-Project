...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="frm" method="post" action="AddLibBranch" onsubmit="return validate(this);">
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Screen To Add Branches<h1></div>
			<br/>
			<%
...
<table align="right">
<tr><td><b>Library Name</b></td><td><input type="text" name="lname" /></td></tr>
<tr><td><b>Location</b></td><td><input type="text" name="lloc"/> </td></tr>
<tr><td></td><td><input type="submit" value="Add Library"></td>
</td></tr></table>
</form>
			</table>
