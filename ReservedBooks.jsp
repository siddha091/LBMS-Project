...
<div id="wrapper">
	...
	try
				...
				Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","library","library");
					...
					ResultSet rs=st.executeQuery("select * from book_checkout where reader_id='"+rid+"' and book_status='Reserved' and user_return_date is null");

		%><br/><br/>
					<table border=1 align=center cellpadding="10">
						<tr><th>Reader Id</th><th>Book Id</th><th>Book Title</th><th>Book Author</th><th>Book Publisher</th><th>Library Id</th><th>Book Issue Date</th><th>Actual Return Date</th><th>Book Status</th><th>Action</th></tr>
		<%
					while(rs.next())
					{ 
		...
		%>						
						...
						<td><a href="ReserveToCheckout?rid=<%=rid%>&bid=<%=rs.getString(2)%>&bname=<%=rs.getString(3)%>&bauthor=<%=rs.getString(4)%>&bpub=<%=rs.getString(5)%>&libid=<%=rs.getString(6)%>">Checkout</a>
