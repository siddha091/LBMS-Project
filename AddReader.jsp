...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="frm" method="post" action="AddReader" onsubmit="return validate(this);">
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Screen To Add Readers<h1></div>
			<br/>
			<%
...
<table align="right">
<tr><td><b>Reader Name</b></td><td><input type="text" name="rname" /></td></tr>
<tr><td><b>Gender</b></td><td><select name="rgender">
<option value="Male">Male</option>
<option value="Female">Female</option>
</td></tr>
<tr><td><b>Contact No</b></td><td><input type="text" name="rmobile"/> </td></tr>
<tr><td><b>Email ID</b></td><td><input type="text" name="remail"/> </td></tr>
<tr><td><b>Qualification</b></td><td><input type="text" name="rqualif"/> </td></tr>
<tr><td><b>Address</b></td><td><input type="text" name="raddr"/> </td></tr>
<tr><td></td><td><input type="submit" value="Add Reader"></td>
</td></tr></table>
</form>
			</table>
