...
public void doPost(HttpServletRequest request, HttpServletResponse response)	throws ServletException, IOException {
    ...
    if(!res.equals("fail")){
		RequestDispatcher rd=request.getRequestDispatcher("AdminSearchResults.jsp?t1=Search Results for Keyword : "+res);
		rd.forward(request, response);
	}else{
		response.sendRedirect("AdminSearch.jsp?t1=No Results Found");
	}
