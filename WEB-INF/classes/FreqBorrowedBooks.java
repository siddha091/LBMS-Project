...
public class FreqBorrowedBooks extends HttpServlet {
public void doPost(HttpServletRequest request, HttpServletResponse response)	throws ServletException, IOException {
    ...
    if(!res.equals("fail")){
		RequestDispatcher rd=request.getRequestDispatcher("FreqBorrowedBooks.jsp?t1="+res);
		rd.forward(request, response);
	}else{
		response.sendRedirect("FreqBorrowedBooks1.jsp?t1=No Results Found");
	}
