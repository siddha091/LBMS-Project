...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="frm" method="post" action="Return" onsubmit="return validate(this);">
		 <br/><br/><br/><br/>
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Book Return Screen<h1></div>
			<br/>
			<%
	...
	System.out.println("In Return.jsp Page"+session.getAttribute("rid"));
	...
	try
				...
				Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","library","library");
					...
					ResultSet rs=st.executeQuery("select * from book_checkout where reader_id='"+rid+"' and user_return_date is null");

		%>
		<br/><br/>
					<table border=1 align="center" cellpadding="10">
						<tr><th>Reader Id</th><th>Book Id</th><th>Book Title</th><th>Book Author</th><th>Book Publisher</th><th>Library Id</th><th>Book Issue Date</th><th>Actual Return Date</th><th>Delay in Return (Days)</th><th>Fine Amount(In Cents)</th><th>Action</th></tr>
		<%
					while(rs.next())
					{ 
						status=rs.getString(10);
						java.util.Date returnDate=rs.getDate(8);
						
						DateFormat df = new SimpleDateFormat("yyyy/MM/dd");
						java.util.Date todayDate = new Date();

						
						long duration  = todayDate.getTime() - returnDate.getTime();
						long diffInDays = TimeUnit.MILLISECONDS.toDays(duration);
						
						if(diffInDays>0)
						{
							fineAmount=diffInDays*20;
						}
						else
						{
							diffInDays=0;
			...
			%>
						...
						<td><%=diffInDays%></td>
					    <td><%=fineAmount%></td>
						<td><a href="Return?rid=<%=rid%>&bid=<%=rs.getString(2)%>&libid=<%=rs.getString(6)%>&delayDays=<%=diffInDays%>&fineAmount=<%=fineAmount%>">Return</a>
