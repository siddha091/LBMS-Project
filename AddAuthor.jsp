...
<div id="wrapper">
	<!-- start page -->
	<div id="page">
		 <form name ="frm" method="post" action="AddAuthor" onsubmit="return validate(this);">
		<!-- start content -->
		<div id="content">
			<div class="flower"><center><h1>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Screen To Add Authors<h1></div>
			<br/>
			<%
...
<table align="right">
<tr><td><b>Author Name</b></td><td><input type="text" name="auname" /></td></tr>
<tr><td><b>Email ID</b></td><td><input type="text" name="auemail"/> </td></tr>
<tr><td><b>Address</b></td><td><input type="text" name="auaddr"/> </td></tr>
